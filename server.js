...
var seafewd12 = connect();

// get reveal files from reveal-md module
['css', 'js', 'images', 'plugin', 'lib'].forEach(function(dir) {
  seafewd12.use('/' + dir, serverStatic(opts.revealBasePath + dir));
});

briancama.use(serverStatic(__dirname + "/dist"));
seafewd12.use(serverStatic(__dirname + "/seafewd12/dist"));

var app = connect();
app.use(compression());
app.use(vhost('seafewd12.briancama.com', seafewd12));
